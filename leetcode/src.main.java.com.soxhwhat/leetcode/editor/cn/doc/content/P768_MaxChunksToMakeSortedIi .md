...
<div><div>Related Topics</div><div><li>栈</li><li>贪心</li><li>数组</li><li>排序</li><li>单调栈</li></div></div><br><div><li>👍 248</li><li>👎 0</li></div>
### 左右区间大小
- 分成若干块排序等于原数组排序，要想让前面的块与后面的块相互无影响，那么左区间的最大值小于等于右区间的最小值。
- 统计每一个坐标下的左区间最大值与右区间最小值，符合条件结果加1.